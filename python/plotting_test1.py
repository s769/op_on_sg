...
# Finding values of alpha, beta [useful in finding boundary values]
from recursions import alpha, beta
from monomials import p_jk, generate_W, generate_T, generate_norm_W, generate_norm_T
...
######## 2. Code for finding Chebyshev Polynomials ########

### Actual work 1: Chebyshev polynomial of order 1 with family 1
...
# extremal_val_h1(10, best_coeff, 0, 0, 1, 0, 0, 4, 7)
...
### Actual work 3: Sup norm of P_{13} + a * P_{03}
...
# extremal_val_h1(10, 0, 0, best_coeff, 0, 0, 1, 3, 7)



### Actual work 4: Sup norm of P_{21} + a * P_{11} + b * P_{01}

# Initialization of the coefficients

### Here we find the optimal value of second 
# # This indicates we evaluate 20 points one time.
# num0 = 500
# num1 = 500
...
# poly_temp = eval_poly_hn(best_coeff_arr, 7)
# print(poly_temp[0])
# extremal_val_hn(20, best_coeff_arr, 3, 7)
# # TODO LATER, after we have the bounds.





######## 3. Code for finding Optimality Conditions ########
...
# Find the extremal value
# extremal_val(div_P21_P01, num_points, flag=2, level=7)
